    ...
    <main className="min-h-screen bg-[#020813] p-4 text-slate-100 sm:p-8">
      <section className="login-scene mx-auto flex min-h-[calc(100vh-2rem)] max-w-5xl flex-col rounded-[2rem] border border-white/10 p-6 shadow-2xl shadow-black/50 sm:min-h-[calc(100vh-4rem)] sm:p-10">
        <div className="flex items-center justify-between gap-4">
          <Brand compact />
          <Link href="/" className="inline-flex items-center gap-2 rounded-lg border border-white/10 px-4 py-2 text-sm font-semibold text-slate-300 transition hover:bg-white/10 hover:text-white">
        ...
        <div className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[0.85fr_1fr]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.35em] text-amber-300/80">Rejestracja</p>
            <h1 className="mt-5 text-4xl font-black leading-tight text-white sm:text-5xl">Utwórz konto w King Delivery Tracker.</h1>
