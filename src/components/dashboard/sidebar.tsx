          ...
          {mobileMenu.map((item) => {
            ...
            return (
              <Link
                key={item.label}
                href={item.href}
                className="flex min-h-14 flex-col items-center justify-center rounded-2xl px-1 py-2 text-[0.68rem] font-semibold transition hover:bg-white/[0.06] hover:text-amber-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber-300"
              >
